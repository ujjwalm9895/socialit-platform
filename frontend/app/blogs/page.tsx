  ...
  return (
    <PublicLayout>
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6 sm:mb-8">Blogs</h1>
        {loading ? (
          ...
          <ul className="space-y-4">
            {published.map((b) => (
              <li key={b.id} className="hover-lift border border-gray-200 rounded-xl p-4 sm:p-5 bg-white shadow-sm">

      ...
      <form onSubmit={save} className="max-w-xl">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
          ...
          <div>
            ...
            <input value={slug} onChange={(e) => setSlug(e.target.value)} placeholder="e.g. cloud-migration" className="w-full border border-slate-200 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-primary" required />
          </div>
          <div>

    ...
    <div className="space-y-6">
      ...
      <form onSubmit={save} className="space-y-4 max-w-xl">
        ...
        <div>
          ...
          <input value={slug} onChange={(e) => setSlug(e.target.value)} placeholder="e.g. acme-cloud-migration" className="w-full border border-gray-300 rounded-lg px-3 py-2" required />
        </div>
        <div>

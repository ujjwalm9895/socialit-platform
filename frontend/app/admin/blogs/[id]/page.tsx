      ...
      <form onSubmit={save} className="max-w-xl">
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
          ...
          <div className="flex gap-3 flex-wrap pt-2">
            ...
            <button type="button" onClick={deleteBlog} disabled={deleting} className="px-5 py-2.5 border border-red-200 text-red-700 rounded-xl font-medium hover:bg-red-50 disabled:opacity-50">
